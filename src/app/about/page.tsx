            ...
            <section className="relative h-[80vh] w-full overflow-hidden flex items-end">
                ...
                <div className="relative w-full max-w-6xl mx-auto px-6 pb-16 md:pb-24 text-center md:text-left">
                    ...
                    <p className="text-slate-200 text-lg md:text-xl max-w-2xl leading-relaxed">
                        In the heart of the Kashmir valley, a passion for cricket breathes. Discover how nature's finest timber is transformed into the world's most coveted cricket bats.
                    </p>
                </div>
            </section>
            ...
            <section className="py-24 px-6 md:px-20">
                <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="order-1 md:order-2 space-y-6">
                        ...
                        <p className="text-slate-600 dark:text-slate-400 text-lg leading-relaxed">
                            A Stag bat isn't manufactured; it's birthed. Our master artisans treat every piece of willow as a unique living entity. They listen to the wood, feeling for the grain and density to ensure every bat is perfectly balanced.
                        </p>
            ...
            <section className="py-20 px-6 mb-20">
                <div className="max-w-4xl mx-auto rounded-3xl bg-primary overflow-hidden relative shadow-2xl">
                    ...
                    <div className="relative z-10 p-10 md:p-16 text-center">
                        <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">Experience the Craft</h2>
                        <p className="text-white/80 text-lg mb-10 max-w-xl mx-auto">From the forest of Kashmir to the boundaries of the world. Own a piece of cricketing excellence.</p>
