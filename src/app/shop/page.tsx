                ...
                <div className="flex-1 flex flex-col gap-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div className="group flex flex-col bg-white dark:bg-slate-900 rounded-xl overflow-hidden border border-slate-200 dark:border-slate-800 hover:shadow-xl hover:shadow-primary/5 hover:border-primary/30 transition-all duration-300">
                            <Link href="/product/thunder-stroke-pro" className="relative aspect-[4/5] bg-slate-100 dark:bg-slate-800 overflow-hidden block">
                            ...
                            <div className="flex flex-col flex-1 p-5">
                                <div className="flex justify-between items-start mb-2">
                                    <Link href="/product/thunder-stroke-pro" className="font-bold text-lg text-slate-900 dark:text-white group-hover:text-primary transition-colors">Thunder Stroke Pro</Link>
                        ...
                        {/* Product Card 2 */}
                        <div className="group flex flex-col bg-white dark:bg-slate-900 rounded-xl overflow-hidden border border-slate-200 dark:border-slate-800 hover:shadow-xl hover:shadow-primary/5 hover:border-primary/30 transition-all duration-300">
                            <Link href="/product/blaster-elite" className="relative aspect-[4/5] bg-slate-100 dark:bg-slate-800 overflow-hidden block">
                            ...
                            <div className="flex flex-col flex-1 p-5">
                                <div className="flex justify-between items-start mb-2">
                                    <Link href="/product/blaster-elite" className="font-bold text-lg text-slate-900 dark:text-white group-hover:text-primary transition-colors">Blaster Elite</Link>
                                    <div className="flex items-center gap-1 text-amber-400 text-xs font-bold">
                                        <span>4.7</span>
                                        <span className="material-symbols-outlined text-[14px] fill-current">star</span>
                                    </div>
                        ...
                        {/* Product Card 3 */}
                        <div className="group flex flex-col bg-white dark:bg-slate-900 rounded-xl overflow-hidden border border-slate-200 dark:border-slate-800 hover:shadow-xl hover:shadow-primary/5 hover:border-primary/30 transition-all duration-300">
                            <Link href="/product/master-blaster" className="relative aspect-[4/5] bg-slate-100 dark:bg-slate-800 overflow-hidden block">
                            ...
                            <div className="flex flex-col flex-1 p-5">
                                <div className="flex justify-between items-start mb-2">
                                    <Link href="/product/master-blaster" className="font-bold text-lg text-slate-900 dark:text-white group-hover:text-primary transition-colors">Stag Master Blaster</Link>
                                    <div className="flex items-center gap-1 text-amber-400 text-xs font-bold">
                                        <span>4.8</span>
                                        <span className="material-symbols-outlined text-[14px] fill-current">star</span>
                                    </div>
                        ...
                        {/* Product Card 4 */}
                        <div className="group flex flex-col bg-white dark:bg-slate-900 rounded-xl overflow-hidden border border-slate-200 dark:border-slate-800 hover:shadow-xl hover:shadow-primary/5 hover:border-primary/30 transition-all duration-300">
                            <Link href="/product/scoop-fire" className="relative aspect-[4/5] bg-slate-100 dark:bg-slate-800 overflow-hidden block">
                            ...
                            <div className="flex flex-col flex-1 p-5 opacity-75">
                                <div className="flex justify-between items-start mb-2">
                                    <Link href="/product/scoop-fire" className="font-bold text-lg text-slate-900 dark:text-white group-hover:text-primary transition-colors">Scoop Fire</Link>
                                    <div className="flex items-center gap-1 text-amber-400 text-xs font-bold">
                                        <span>4.5</span>
                                        <span className="material-symbols-outlined text-[14px] fill-current">star</span>
                                    </div>
                        ...
                        {/* Product Card 5 */}
                        <div className="group flex flex-col bg-white dark:bg-slate-900 rounded-xl overflow-hidden border border-slate-200 dark:border-slate-800 hover:shadow-xl hover:shadow-primary/5 hover:border-primary/30 transition-all duration-300">
                            <Link href="/product/classic-drive" className="relative aspect-[4/5] bg-slate-100 dark:bg-slate-800 overflow-hidden block">
                            ...
                            <div className="flex flex-col flex-1 p-5">
                                <div className="flex justify-between items-start mb-2">
                                    <Link href="/product/classic-drive" className="font-bold text-lg text-slate-900 dark:text-white group-hover:text-primary transition-colors">Classic Drive</Link>
                                    <div className="flex items-center gap-1 text-amber-400 text-xs font-bold">
                                        <span>5.0</span>
                                        <span className="material-symbols-outlined text-[14px] fill-current">star</span>
                                    </div>
                        ...
                        {/* Product Card 6 */}
                        <div className="group flex flex-col bg-white dark:bg-slate-900 rounded-xl overflow-hidden border border-slate-200 dark:border-slate-800 hover:shadow-xl hover:shadow-primary/5 hover:border-primary/30 transition-all duration-300">
                            <Link href="/product/limited-edition-willow" className="relative aspect-[4/5] bg-slate-100 dark:bg-slate-800 overflow-hidden block">
                            ...
                            <div className="flex flex-col flex-1 p-5">
                                <div className="flex justify-between items-start mb-2">
                                    <Link href="/product/limited-edition-willow" className="font-bold text-lg text-slate-900 dark:text-white group-hover:text-primary transition-colors">Limited Edition Willow</Link>
                                    <div className="flex items-center gap-1 text-amber-400 text-xs font-bold">
                                        <span>5.0</span>
                                        <span className="material-symbols-outlined text-[14px] fill-current">star</span>
                                    </div>
