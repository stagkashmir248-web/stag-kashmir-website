        ...
        <>
                ...
                <div className="relative w-full h-[500px] md:h-[600px] rounded-2xl overflow-hidden bg-gray-900 group">
                    ...
                    <div className="relative h-full flex flex-col justify-end items-start p-8 md:p-16 max-w-3xl">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            <Link to="/shop" className="px-8 py-4 bg-primary hover:bg-primary-dark text-white font-bold rounded-lg transition-all duration-300 transform hover:-translate-y-1 shadow-lg shadow-primary/30 flex items-center justify-center gap-2">
                                Shop Collection
                                <span className="material-symbols-outlined text-sm">arrow_forward</span>
                            </Link>
                            <Link to="/custom-bat" className="px-8 py-4 bg-white/10 hover:bg-white/20 backdrop-blur-md text-white border border-white/30 font-bold rounded-lg transition-all duration-300 flex items-center justify-center gap-2">
                                View Custom Bats
                            </Link>
                        </div>
                    </div>
            ...
            <section className="px-4 md:px-10 py-12 md:py-16 max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <Link to="/shop" className="group relative flex flex-col gap-4">
                    ...
                    <Link to="/custom-bat" className="group relative flex flex-col gap-4">
                        <div className="relative aspect-[4/5] w-full overflow-hidden rounded-xl bg-gray-100 dark:bg-gray-800">
